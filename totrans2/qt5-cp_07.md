...
Android SDK and NDK can be obtained on the Android developer website, [http://developer.android.com](http://developer.android.com).
...
Let's edit the `main.qml` file as shown here:
