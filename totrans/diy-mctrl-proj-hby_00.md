...
[*第11章*](B16413_11_Final_NM_ePub.xhtml#_idTextAnchor145)，*物联网太阳能（电压）测量*，继续使用运行在微控制器板上的物联网软件，通过ESP8266 WiFi模块测量从太阳能板通过传感器获得的电压。该应用将使用ESP8266 WiFi信号将传感器数据发送到互联网。
