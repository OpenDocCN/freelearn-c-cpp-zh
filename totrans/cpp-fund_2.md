...
![Figure 2.1: Lifetime of an object](img/C11557_02_02.jpg)
...
C++ offers the `std::pow` function for the `std::sqrt` function, which takes the number to square. Both are in the `cmath` header.
