...
There is a lot of material to absorb here. Don't feel discouraged if you don't get it at first. The goal is not to become an expert in game development overnight—that's just not possible. Repetition is the key to learning complex topics; the more you work with Godot's features, the more familiar and *easy* they will start to seem. Try looking back at [Chapter 2](part0079.html#2BASE0-5809b3bef8d2453086d97dfad17b2ee2), *Coin Dash*, when you finish [Chapter 7](part0243.html#77NOM0-5809b3bef8d2453086d97dfad17b2ee2), *Additional Topics*. You'll be surprised at how much more you'll understand compared to the first time you read it.
...
It also means that you can directly contribute to Godot's future. See [Chapter 7](part0243.html#77NOM0-5809b3bef8d2453086d97dfad17b2ee2), *Additional Topics*, for more information about how you can get involved with Godot development.
...
In addition to the three supported scripting languages, Godot itself is written in C++ and you can get even more performance and control by extending the engine's functionality directly. See [Chapter 7](part0243.html#77NOM0-5809b3bef8d2453086d97dfad17b2ee2), *Additional Topics*, for information on using other languages and extending the engine.
...
You're ready to move on to [Chapter 2](part0036.html#12AK80-5809b3bef8d2453086d97dfad17b2ee2), *Coin Dash*, where you'll start building your first game in Godot.