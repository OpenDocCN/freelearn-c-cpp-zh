...
如果我们看*x*轴，值 1 和 2 指定了从原点（值为 0）沿该轴的点的距离。所以，*x*轴上的点 1 位于(1, 0, 0)。同样，沿*y*轴的点 1 位于(0, 1, 0)。
...
因此，![图片](img/d5f5d2ef-1ae8-4fb5-9035-375298c51c41.png)的长度为 9.11 单位。
...
![图片 5](img/3c0e36de-a1eb-4fad-86c6-3c64682d14a4.png)
